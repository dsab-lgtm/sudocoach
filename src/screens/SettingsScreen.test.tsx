...
describe('SettingsScreen', () => {
  ...
  it('confirms destructive clearing and restores focus when cancelled', async () => {
    ...
    const dialog = screen.getByRole('alertdialog', { name: 'Clear saved puzzles?' })
    ...
    expect(screen.queryByRole('alertdialog', { name: 'Clear saved puzzles?' })).not.toBeInTheDocument()
  ...
  it('keeps the confirmation open and announces a clearing failure', async () => {
    ...
    expect(screen.getByRole('alertdialog', { name: 'Clear saved puzzles?' })).toBeInTheDocument()
  })
})
